# AGENTS.md — Not Just For Looks - Without Weapons
...
NJFL variant with weapon blocks removed — for servers that don't want the combat additions.
...
**Board:** [NJFL Without Weapons board](https://github.com/orgs/gitpush-mod/projects/7)
